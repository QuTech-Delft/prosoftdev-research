...
- Explain what the purpose of GitLab is, in the context of version control
- Explain the TUD-managed GitLab server and how to access it

## Navigation

- Login into TUD GitLab account
- Use Web GUI to find projects/groups
